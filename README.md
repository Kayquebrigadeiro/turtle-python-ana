# turtle-python
This repository is a collection of [Python](https://www.python.org/) 🐍 scripts that use the [Turtle](https://docs.python.org/3/library/turtle.html) library to foster creative programming through digital art. Based on the book [Fun With Python: Using Turtle Graphics](https://amzn.to/4319zoF) 📕.

## 🧑‍💻 You can create...

### • [01](https://github.com/Sandreke/turtle-python/blob/main/01.py):
...
### • [02](https://github.com/Sandreke/turtle-python/blob/main/02.py):
...
### • [06](https://github.com/Sandreke/turtle-python/blob/main/06.py):
...
### • [07](https://github.com/Sandreke/turtle-python/blob/main/07.py):
